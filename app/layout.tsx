...
export const metadata: Metadata = {
  title: "Portfolio: Hardik Pampaniya",
  description:
    "Hardik Pampaniya is FullStack Web Developer and Currently working at Netclues India Private Limited",
  keywords: "HardikPampanya, HardikP, hardikpampaniya portfolio",
};
